...
export const ta: Dictionary = {
  ...
  reminders: {
    ...
    botUnknown:
      'அந்த இணைப்பு தெரியவில்லை. Colonaid செயலியைத் திறந்து உள்நுழைந்து, Telegram இணைக்கவும் என்பதை அழுத்தவும்.',
    titleFirst: 'முதல் அளவு {time}',
    titleSecond: 'இரண்டாவது அளவு {time}',
    lead: 'உங்கள் குடல் தயாரிப்பு 30 நிமிடங்களில் தொடங்குகிறது.',
    body: 'முழு விவரங்களுக்கு Colonaid செயலியைத் திறக்கவும்.',
