 ...
 * required; the link is courtesy). Ported from the Expo app's icon set rather
 * than pulled in as a dependency, so the two apps draw the same shapes, and as
 * inline SVG rather than as image assets so they tint and scale like type.
 *
 ...
 *
 * Every icon is a 24x24 grid, stroked, `strokeWidth` 2 at nominal size. **The
